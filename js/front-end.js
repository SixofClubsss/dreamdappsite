$(function () {
  ...
  // set directly by the script tag:
  // window.silex.data
  ...
  window.silex.getCurrentPage = function () {
    var pagefile = $body.pageable;
    var currentPageName = pagefile ? pagefile().data()['silexlabs-pageable'].options.currentPage : $body.attr('data-current-page');
